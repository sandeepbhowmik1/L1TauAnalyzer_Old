...
process.TallinnL1PFTauAnalyzer.histRootFileName = cms.string("hist_test_TallinnL1PFTauAnalyzer_VBFHToTauTau_20190508.root")
process.p = cms.Path(
	process.AnalyzerSeq
)
process.schedule = cms.Schedule(process.p)
process.TFileService=cms.Service('TFileService',fileName=cms.string("NTuple_test_TallinnL1PFTauAnalyzer_VBFHToTauTau_20190508.root"))
