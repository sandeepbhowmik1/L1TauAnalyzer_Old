...
run_cmd('rm %s' % "NTuple_test_TallinnL1PFTauAnalyzer_VBFHToTauTau_"+tagNTuple+".root") 
run_cmd('hadd %s %s' % ("NTuple_test_TallinnL1PFTauAnalyzer_VBFHToTauTau_"+tagNTuple+".root", "NTuple_test_TallinnL1PFTauAnalyzer_VBFHToTauTau_"+tagNTuple+"_part_*.root"))
run_cmd('mv %s %s' % ("NTuple_test_TallinnL1PFTauAnalyzer_VBFHToTauTau_"+tagNTuple+".root", pathNTuple_TallinnL1PFTau))

run_cmd('rm %s' % "NTuple_test_L1PFTauAnalyzer_VBFHToTauTau_"+tagNTuple+".root")
run_cmd('hadd %s %s' % ("NTuple_test_L1PFTauAnalyzer_VBFHToTauTau_"+tagNTuple+".root", "NTuple_test_L1PFTauAnalyzer_VBFHToTauTau_"+tagNTuple+"_part_*.root"))
run_cmd('mv %s %s' % ("NTuple_test_L1PFTauAnalyzer_VBFHToTauTau_"+tagNTuple+".root", pathNTuple_L1PFTau))
...
scriptFile = os.path.join(workingDir, "script/efficiencyPlot", "make_SummaryTable_Rate_Efficiency.py")
fileName_In_TallinnL1PFTau = os.path.join(pathNTuple_TallinnL1PFTau, "NTuple_test_TallinnL1PFTauAnalyzer_VBFHToTauTau_"+tagNTuple+".root")
treeName_In_TallinnL1PFTau = 'TallinnL1PFTauAnalyzer/TallinnL1PFTauAnalyzer'
fileName_In_txt_TallinnL1PFTau = os.path.join(workingDir, "script/ratePlot/results", "hist_rate_TallinnL1PFTau_NeutrinoGun_"+tagPlot+".txt")
