...
L1HPSPFDiTauAnalyzer = cms.EDAnalyzer("L1HPSPFDiTauAnalyzer",
                                    ...
                                    l1PFDiTauToken     = cms.InputTag("L1HPSPFDiTauProducerWithStripsWithoutPreselectionPF"),    # _3 
                                    ...
                                    bdtRootFileName    = cms.string("bdt_test_L1HPSPFDiTauAnalyzer.root"),
                                    treeBDTName        = cms.string("L1PFTauAnalyzer"),
                                    createHistRoorFile = cms.untracked.bool(True),
                                    histRootFileName   = cms.string("hist_test_L1HPSPFDiTauAnalyzer.root"),
                                    #histRootFileName   = cms.string("hist_test_L1HPSPFDiTauAnalyzer_GluGluHToTauTau.root"),
                                    #histRootFileName   = cms.string("hist_test_L1HPSPFDiTauAnalyzer_NeutrinoGun.root"),
                                    )
