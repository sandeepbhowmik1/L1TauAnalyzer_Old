...
#treeName_In_L1HPSPFTau = 'L1HPSPFTauAnalyzer/L1HPSPFTauAnalyzer'
...
fileName_Out_L1HPSPFTau = os.path.join(pathNTuple_L1HPSPFTau, "NTuple_test_L1HPSPFTauAnalyzer_GluGluHToTauTau_"+"forEfficiency_"+tagPlot+".root")
...
treeName_In_L1HPSPFTau = 'L1HPSPFTauAnalyzer/L1PFTauAnalyzer'
fileName_In_txt_L1HPSPFTau = os.path.join(workingDir, "script/ratePlot/results", "hist_rate_L1HPSPFTau_NeutrinoGun_"+tagPlot+".txt")
fileName_Out_L1HPSPFTau = os.path.join(workingDir, "script/efficiencyPlot/results", "summaryTable_Rate_Efficiency_L1HPSPFTau_"+tagPlot+".txt")
run_cmd('python %s %s %s %s %s' % (scriptFile, fileName_In_L1HPSPFTau, treeName_In_L1HPSPFTau, fileName_In_txt_L1HPSPFTau, fileName_Out_L1HPSPFTau))
...
fileName_In_L1HPSPFTau = os.path.join(pathNTuple_L1HPSPFTau, "NTuple_test_L1HPSPFTauAnalyzer_GluGluHToTauTau_"+"forEfficiency_"+tagPlot+".root") 
fileName_Out_L1HPSPFTau = os.path.join(workingDir, "script/efficiencyPlot/results", "fitOutput_efficiency_L1HPSPFTau_GluGluHToTauTau_vs_Pt_"+tagPlot+".root") 
...
scriptPlot_Efficiency = os.path.join(workingDir, "script/efficiencyPlot/macro", "plot_compare_Efficiency_L1PFTau_vs_L1HPSPFTau_Pt.py")
fileName_Out_Efficiency = os.path.join(workingDir, "script/efficiencyPlot/plots", "plot_compare_Efficiency_L1PFTau_vs_L1HPSPFTau_Pt_"+tagPlot) 
run_cmd('python %s %s %s %s' % (scriptPlot_Efficiency, fileName_Out_L1HPSPFTau, fileName_Out_L1PFTau, fileName_Out_Efficiency)) 
...
run_cmd('python %s %s %s %s' % (scriptFile, fileName_In_L1HPSPFTau, treeName_In_L1HPSPFTau, fileName_Out_L1HPSPFTau))
