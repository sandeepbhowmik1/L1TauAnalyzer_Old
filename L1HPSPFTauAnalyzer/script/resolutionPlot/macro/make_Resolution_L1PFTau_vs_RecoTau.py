...
treeIn.Draw("l1tEta - tauEta >> hEta_Data", "tauPt > 26")
treeIn.Draw("l1tPt / tauPt >> hEt_Data", "tauPt > 26")
treeIn.Draw("l1tPhi - tauPhi >> hPhi_Data", "tauPt > 26")

treeIn.Draw("l1tEta - tauEta >> hEta_Data_barrel", "TMath::Abs(tauEta) < 1.305 && tauPt > 26")
treeIn.Draw("l1tPt / tauPt >> hEt_Data_barrel", "TMath::Abs(tauEta) < 1.305 && tauPt > 26")
treeIn.Draw("l1tPhi - tauPhi >> hPhi_Data_barrel", "TMath::Abs(tauEta) < 1.305 && tauPt > 26")

treeIn.Draw("l1tEta - tauEta >> hEta_Data_endcap", "TMath::Abs(tauEta) > 1.479 && tauPt > 26")
treeIn.Draw("l1tPt / tauPt >> hEt_Data_endcap", "TMath::Abs(tauEta) > 1.479 && tauPt > 26")
treeIn.Draw("l1tPhi - tauPhi >> hPhi_Data_endcap", "TMath::Abs(tauEta) > 1.479 && tauPt > 26")
