...
public:
  explicit L1HPSPFDiTauAnalyzer(const edm::ParameterSet&);
  ~L1HPSPFDiTauAnalyzer();
...
private:
  ...
  edm::EDGetTokenT<l1t::L1HPSPFDiTauCollection>  l1PFDiTauToken_;
...
L1HPSPFDiTauAnalyzer::L1HPSPFDiTauAnalyzer(const edm::ParameterSet& iConfig)
 :
  debug_          (iConfig.getUntrackedParameter<bool>("debug", false)),
  l1PFTauToken_   (consumes<l1t::L1HPSPFTauCollection>          (iConfig.getParameter<edm::InputTag>("l1PFTauToken"))),
  l1PFDiTauToken_   (consumes<l1t::L1HPSPFDiTauCollection>          (iConfig.getParameter<edm::InputTag>("l1PFDiTauToken"))),
...
L1HPSPFDiTauAnalyzer::~L1HPSPFDiTauAnalyzer()
{
...
void
L1HPSPFDiTauAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  Initialize();
  ...
  if(debug_){
   ...
   edm::Handle<l1t::L1HPSPFDiTauCollection>  l1PFDiTauHandle;
   iEvent.getByToken(l1PFDiTauToken_,            l1PFDiTauHandle);
   ...
   for(auto l1PFDiTau : *l1PFDiTauHandle){
     //     if(debug_){
     std::cout<<" L1PFDiTau leadingL1HPSPFTau pt  "<< l1PFDiTau.leadingL1HPSPFTau()->pt() <<std::endl;
     std::cout<<" L1PFDiTau subleadingL1HPSPFTau pt  "<< l1PFDiTau.subleadingL1HPSPFTau()->pt() <<std::endl;
     std::cout<<" L1PFDiTau dz "<<l1PFDiTau.dz()<<std::endl;
       //     }
...
void L1HPSPFDiTauAnalyzer::Initialize() {
  indexevents_ = 0;
  runNumber_ = 0;
  lumi_ = 0;
  MC_weight_ = 1;
...
DEFINE_FWK_MODULE(L1HPSPFDiTauAnalyzer);
